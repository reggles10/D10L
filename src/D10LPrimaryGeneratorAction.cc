...
D10LPrimaryGeneratorAction::D10LPrimaryGeneratorAction()
...
void D10LPrimaryGeneratorAction::GeneratePrimaries(G4Event * anEvent)
{
  ...
  if(fWorld)
  ...
  else
    {
      ...
      G4Exception("D10LPrimaryGeneratorAction::GeneratePrimaries()",
